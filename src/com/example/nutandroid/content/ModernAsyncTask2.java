 ...
 * </ul>
 */
public abstract class ModernAsyncTask2<Params, Progress, Result>
{
	 ...
	 */
	public final ModernAsyncTask2<Params, Progress, Result> execute(Params... params)
	{
	 ...
	 *             {@link AsyncTask.Status#FINISHED}.
	 */
	public final ModernAsyncTask2<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params)
	{
	...
	{
		@SuppressWarnings("rawtypes")
		final ModernAsyncTask2 mTask;
		final Data[] mData;

		AsyncTaskResult(@SuppressWarnings("rawtypes") ModernAsyncTask2 task, Data... data)
		{
			mTask = task;
			mData = data;
		}
